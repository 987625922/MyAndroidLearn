...
public final class NetUtils {
    private static NetConnChangedReceiver netConnChangedReceiver = new NetConnChangedReceiver();
    private static List<NetConnChangedListener> netConnChangedListeners = new ArrayList<>();
    private NetUtils() {
    ...
    public static void registerNetConnChangedReceiver(Context context) {
        ...
        context.registerReceiver(netConnChangedReceiver, filter);
    }
    ...
    public static void unregisterNetConnChangedReceiver(Context context) {
        checkNonNull(context, "context == null");
        context.unregisterReceiver(netConnChangedReceiver);
        netConnChangedListeners.clear();
    }
    ...
    public static void addNetConnChangedListener(NetConnChangedListener listener) {
        ...
        netConnChangedListeners.add(listener);
    }
    ...
    public static void removeNetConnChangedListener(NetConnChangedListener listener) {
        checkNonNull(listener, "listener == null");
        netConnChangedListeners.remove(listener);
    }

    private static void broadcastConnStatus(ConnectStatus connectStatus) {
        int size = netConnChangedListeners.size();
        if (size == 0) {
            return;
        }
        for (int i = 0; i < size; i++) {
            netConnChangedListeners.get(i).onNetConnChanged(connectStatus);
        }
    }
