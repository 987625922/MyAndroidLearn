...
public class SDCardHelper {
    ...
    // 往SD卡的私有Files目录下保存文件  storage/sdcard/Android/data/包名/files
    ...
    // 往SD卡的私有Cache目录下保存文件 storage/sdcard/Android/data/包名/cache
